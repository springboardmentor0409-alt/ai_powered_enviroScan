...
def train_decision_tree(input_path, model_path, results_path, seed=42):
    ...
    joblib.dump(model, f"{model_path}/decision_tree.joblib")
    ...
    # Feature importance (extract if available)
    try:
        # get trained tree inside pipeline
        ...
        plot_feature_importance(tree, feat_names, f"{results_path}/feature_importance.png", top_n=30)
    ...
    print("\n Decision Tree training & plotting complete!\n")
